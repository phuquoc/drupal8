...
class Freelinking extends FilterBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, FreelinkingManagerInterface $freelinkingManager, AccountProxyInterface $current_user) {
        ...
        if (!$this->settings['global_options']['ignore_upi'] || $current_plugin) {
          ...
          if (!$current_plugin) {
            ...
            $link = $result->createPlaceholder(
              ...
              [$current_plugin->getPluginId(), $target, $indicator, $user_langcode, serialize($plugin_settings)]
            );
          }
